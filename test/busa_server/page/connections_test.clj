...
(fact "should create new page details"
  (connections-page/new-details place/nummela place/helsinki "2016-02-01") =>
    {:arrival-place-id "p1001" :departure-place-id "p1447" :departure-date "2016-02-01"})
...
(fact "should format url for connections page"
  (connections-page/url connection-page-details) =>
    "https://liput.matkahuolto.fi/connectionlist?lang=fi&arrivalPlaceId=p1001&departurePlaceId=p1447&departureDate=2016-01-01")
